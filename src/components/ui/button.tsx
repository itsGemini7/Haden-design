  ...
  "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        navCta: "text-foreground bg-nav-button hover:bg-nav-button/85 active:scale-[0.97] transition-all border border-border/40",
        hero: "bg-primary text-primary-foreground hover:brightness-110 active:scale-[0.97] transition-all",
        heroOutline: "border border-border/80 bg-background text-foreground hover:bg-muted active:scale-[0.97] transition-all",
      },
      size: {
